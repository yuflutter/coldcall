...
import 'package:coldcall/features/storage_sync/_storage_sync_vm.dart';
import 'package:flutter/material.dart';
import 'package:gap/gap.dart';
import 'package:mobile_scanner/mobile_scanner.dart';
import 'package:qr_flutter/qr_flutter.dart';

Future<void> showStorageSyncScreen(BuildContext context) {
  return Navigator.push(context, MaterialPageRoute(builder: (context) => StorageSyncScreen()));
}
...
class _StorageSyncScreenState extends State<StorageSyncScreen> {
  late final _model = StorageSyncVm();
