...
enum _HeaderLocation { top, bottom }
...
class _DealCardState extends State<DealCard> {
  ...
  void _expandCollapseDealCard() {
    if (_deal.notDeletedAndSortedRecords.isEmpty) {
  ...
  Widget _buildHeader(_HeaderLocation location) {
    return InkWell(
      onTap: _expandCollapseDealCard,
      onLongPress: _showDeleteDealDialog,
      child: Card(
  ...
  void _showDeleteDealDialog() {
    _model.expandCollapseDealCard(_deal, forceSet: true);
